...
def compile_output_list(wildcards):
    ...
    files = {
        ...
        "biomarker/fragmentomics_metrics/metrics/se": [".SE.tsv"],
        "biomarker/fragmentomics_metrics/metrics/depth": [".depth.tsv"],
        "biomarker/fragmentomics_metrics/metrics/frag_bins": [".fragbins.tsv"],
        "biomarker/fragmentomics_metrics/metrics/small_frags": [".smallfrag.tsv"],
        "biomarker/fragmentomics_metrics/metrics/full_gene_depth": [".fullgenedepth.tsv"],
        "biomarker/fragmentomics_metrics/metrics/mds": ["_mds.txt"],
        "biomarker/fragmentomics_metrics/metrics/TFBS_entropy": ["_TFBS_entropy.txt"],
        "biomarker/fragmentomics_metrics/metrics/ATAC_entropy": ["_ATAC_entropy.txt"],
