...
def compile_output_list(wildcards):
    ...
    files = {
        ...
        "biomarker/fragmentomics_metrics_calculate_SE": [".SE.tsv"],
        "biomarker/fragmentomics_metrics_calculate_normalized_depth": [".depth.tsv"],
        "biomarker/fragmentomics_metrics_calculate_frag_bins": [".fragbins.tsv"],
        "biomarker/fragmentomics_metrics_calculate_small_frags": [".smallfrag.tsv"],
        "biomarker/fragmentomics_metrics_calculate_full_gene_depth": [".fullgenedepth.tsv"],
